...
Approved Builder source: `agent/site-builder-v2-final-hybrid` at
`c25e506d2174d6693774793ed1ed602365c1a5e7` (tree
`4584267adb635c415945959e58b52ca87bf9948e`). Approved Booking source:
`agent/booking-section-design-lab` at
`3860e7090750d8cfa7a971566b063df989f722d5` (tree
`ab883d5f64ff5695e3d762804c5cf071a9f356b4`).
...
| Approved Site Builder | package-local Vite, TypeScript, Vitest, Playwright, HTML, package, and ignore files | `c25e506d2174d6693774793ed1ed602365c1a5e7` | package root | Standalone loopback-only Lab entrypoint and focused verification | Yes — the onboarding fork binds only to port 4188 |
...
| Approved Booking Lab | `prototypes/booking-section-design-lab/src/model/{data,model,settings,types}.ts` | `3860e7090750d8cfa7a971566b063df989f722d5` | `src/booking/{data,helpers,presentation,types}.ts` | Immutable 24-service fixtures, 100-service generator, pricing/duration helpers, session calculations, and presentation validation | Yes — adapted into one mock-data provider and a strict discriminated document contract |
| Approved Booking Lab | `prototypes/booking-section-design-lab/src/components/{BookingLayouts,BookingPreview,LabDialogs,SettingsPanel}.tsx` | `3860e7090750d8cfa7a971566b063df989f722d5` | `src/booking/{BookingLayouts,BookingSectionRenderer,Handoff,SelectedSummary,ServiceDetail,SettingsPanel}.tsx` | Five approved layouts, one renderer, shared detail/summary/handoff, and curated owner controls | Yes — one Builder-owned settings surface and explicit edit/preview modes |
