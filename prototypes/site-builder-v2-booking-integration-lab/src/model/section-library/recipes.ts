...
export const WEBSITE_RECIPES: readonly WebsiteRecipe[] = [
  ...
  {
    audience: 'Nail business that wants its complete story on one polished page.',
    description: 'A complete nail-business website on one scrolling page, with real reviews and policies included only when they exist.',
  ...
  {
    audience: 'Nail business that wants clear destinations for each customer task.',
    description: 'Five deliberate pages: Home, Services & Booking, Gallery, About, and Contact — with no repeated full sections.',
    id: 'the_collective',
