...
export const SCREEN_METADATA: Record<OnboardingScreenId, OnboardingScreenMetadata> = {
  ...
  site_style: {
    heading: 'Make it feel like yours',
    primaryAction: 'Use this look',
    stage: 'design',
    status: 'essential',
    supportingCopy: 'Choose a style and colours for your site. You can change them anytime.',
  },
  save_progress: {
    heading: 'Your site is coming together ✨',
    primaryAction: 'Create your free account',
    secondaryAction: 'Back',
    stage: 'design',
    status: null,
    supportingCopy: 'Create your free Luster account to save your progress and keep building your online booking site.',
  },
  starter: {
