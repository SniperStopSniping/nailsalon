module.exports = {
  ...
  // the old development migration on migration changes. Both were removed deliberately.
  //
  ...
  // registers it in _journal.json. The old migration command then ran in the same hook,
