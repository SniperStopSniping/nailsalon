...
- STOP/START/HELP wording is saved. **Advanced Opt-Out is not enabled**; obtain explicit approval because Twilio Support is required to disable it afterward. Provider configuration does not substitute for deploying and verifying the repaired application.
