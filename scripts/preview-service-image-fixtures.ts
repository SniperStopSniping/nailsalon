...
const FINAL_MIGRATION = '0087_network_no_show_protection';
const MIGRATION_COUNT = 87;
...
const EXPECTED_INCOMING_FOREIGN_KEYS = [
  ...
  ['public', 'review_request_trigger', 'review_request_trigger_salon_id_salon_id_fk', ['salon_id'], 'public', 'salon', ['id'], 'NO ACTION', 'CASCADE'],
  ...
  ['public', 'salon_discover_settings', 'salon_discover_settings_salon_id_fkey', ['salon_id'], 'public', 'salon', ['id'], 'NO ACTION', 'CASCADE'],
  ...
  ['public', 'salon_portfolio_photo', 'salon_portfolio_photo_salon_id_fkey', ['salon_id'], 'public', 'salon', ['id'], 'NO ACTION', 'CASCADE'],
  ...
  ['public', 'network_no_show_participation', 'network_no_show_participation_salon_id_salon_id_fk', ['salon_id'], 'public', 'salon', ['id'], 'NO ACTION', 'CASCADE'],
  ...
  ['public', 'salon_portfolio_photo', 'salon_portfolio_photo_location_id_fkey', ['location_id'], 'public', 'salon_location', ['id'], 'NO ACTION', 'SET NULL'],
