...
describe('migration 0068 — D6.1 invoice and tax snapshot foundation', () => {
  ...
  it('pins the immutable Stripe prerequisite before the Review migration', () => {
    ...
    expect(journal.entries).toHaveLength(87);
  ...
  it.each([
    ...
    [77, 'Stripe 0076'],
    [78, 'Review 0077'],
  ])('upgrades a %s ledger through review requests, intraday blocks and Next Visit Offers through 0086', async (existingCount) => {
