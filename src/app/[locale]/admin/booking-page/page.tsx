      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-6 flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold">{({ business: 'Business Information', layouts: 'Layout & Menu', appearance: 'Style & Colours', information: 'What Clients See', text: 'About & Website Text', gallery: 'Photos & Gallery', policies: 'Policies Display', experience: 'Booking Messages & Social Links', flow: 'Booking Flow', publish: 'Preview & Publish' } as Record<string, string>)[panel ?? ''] ?? 'Layout, style and content'}</h1>
