...
function period(start: string, revenue: number) {
  return {
    ...
    depositCollectedCents: 2000,
    depositRefundedCents: 500,
    depositForfeitedCents: 0,
    depositAppliedCents: 2000,
    unresolvedDepositApplicationCount: 0,
    unattributedPaymentEventCount: 0,
    unattributedDepositEventCount: 0,
    unresolvedDepositEventCount: 0,
    tipsCents: 500,
    taxCents: 1300,
    discountsCents: 1000,
