  ...
  return (
    ...
    >
      <section
        ...
        className="mb-5 overflow-hidden rounded-[1.75rem] border bg-white shadow-[0_14px_40px_rgba(78,45,57,0.09)]"
      ...
      >
        <div className="p-4 sm:p-5">
          <div className="flex min-w-0 items-center gap-3 sm:gap-4">
            ...
            <div className="min-w-0 flex-1">
              <h1
                ...
                className="break-words text-xl font-bold leading-tight tracking-tight text-neutral-950 sm:text-2xl"
              >
          ...
          {hasSecondaryActions
            ? (
                <div
                  ...
                  className={`mt-3 grid gap-2 border-t border-neutral-100 pt-3 ${secondaryLinkCount === 2 ? 'sm:grid-cols-2' : 'grid-cols-1'}`}
                >
          ...
          {profile.bio
            ? (
                <p data-testid="quick-book-bio" className="mt-3 whitespace-pre-line break-words rounded-2xl bg-[color-mix(in_srgb,var(--theme-primary)_8%,white)] px-3.5 py-3 text-sm leading-5 text-neutral-700">
                  {profile.bio}
                </p>
              )
            : null}
