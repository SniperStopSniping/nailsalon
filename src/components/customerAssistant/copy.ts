...
export const customerAssistantCopy: Record<CustomerAssistantLocale, CustomerAssistantCopy> = {
  en: {
    ...
    welcome: salonName => `Hey! Welcome to ${salonName} 💅 I’m your AI booking assistant. How can I help today?`,
    ...
    unavailable: {
      ...
      rate_limited: 'The AI assistant is temporarily unavailable. Please try again later, or continue booking manually.',
  ...
  fr: {
    ...
    welcome: salonName => `Bonjour! Bienvenue chez ${salonName} 💅 Je suis votre assistante IA pour les réservations. Comment puis-je vous aider?`,
    ...
    unavailable: {
      ...
      rate_limited: 'L’assistant IA est temporairement indisponible. Réessayez plus tard ou poursuivez votre réservation manuellement.',
