...
const scheduleCopy = {
  en: {
    ...
    pending: 'This time is not held and no appointment has been created. Booking confirmation is not available in this pilot stage.',
  ...
  fr: {
    ...
    pending: 'Cette heure n’est pas réservée et aucun rendez-vous n’a été créé. La confirmation n’est pas disponible à cette étape du pilote.',
