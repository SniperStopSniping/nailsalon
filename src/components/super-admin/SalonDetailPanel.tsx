...
export function SalonDetailPanel({ salonId, onClose, onDeleted }: SalonDetailPanelProps) {
  ...
  const handleBookingExperienceEntitlementChange = useCallback((
    nextState: BookingExperienceEntitlementOverrideServerState,
  ) => {
    setSalon(currentSalon => currentSalon
      ? {
          ...currentSalon,
          features: nextState.features,
          bookingExperienceEntitlement:
            nextState.bookingExperienceEntitlement,
        }
      : currentSalon);
                      ...
                      >
                        ...
                        >
                          <BookingExperienceEntitlementOverrideControl
                            salonId={salonId}
                            inspection={salon.bookingExperienceEntitlement}
                            onServerStateChange={
                              handleBookingExperienceEntitlementChange
                            }
                          />
                        </div>
                          ...
                          <div className="border-t border-gray-200 pt-4">
                            ...
                            <div className="space-y-2 rounded-lg border border-gray-200 bg-gray-50 p-3 text-sm text-gray-700">
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium">$10 off first appointment</span>
                              </div>
                              <div className="flex justify-between">
                                <span>Referrer reward</span>
                                <span className="font-medium">$10 off any appointment</span>
                              </div>
                              <div className="flex justify-between">
                                <span>Google review reward</span>
                                <span className="font-medium">$10 off (manual grant)</span>
                              </div>
                            </div>
                          </div>
