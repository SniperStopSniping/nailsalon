          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="space-y-5 p-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <label htmlFor="multiLocation" className="text-sm font-medium text-gray-700">Multi-location Features</label>
                ...
                >
                  <input
                    ...
                    onChange={() => setIsMultiLocationEnabled(!isMultiLocationEnabled)}
                    disabled={plan === 'single_salon' || plan === 'free'}
                    className="sr-only"
                  />
                  <span
