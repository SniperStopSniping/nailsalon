/**
 * Official provider marks for the account gate. Both use the providers' own
 * published geometry; the Google G keeps its official four colours and the
 * Apple mark is rendered in the button's text colour per Apple's compatible
 * monochrome treatment. Marks are decorative — each button's visible label
...
export function GoogleMark({ size = 18 }: { size?: number }) {
  return (
    ...
    >
      ...
      <path d="M24 10.75c3.23 0 6.13 1.11 8.41 3.29l6.31-6.31C34.91 4.18 29.93 2 24 2 15.4 2 7.96 6.93 4.34 12.42l7.35 5.7c1.73-5.2 6.58-9.07 12.31-9.07z" fill="#EA4335" />
    </svg>
  );
}
