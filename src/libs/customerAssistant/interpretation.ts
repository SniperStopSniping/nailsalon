...
export const CUSTOMER_INTERPRETATION_JSON_SCHEMA = {
  ...
  required: ['factUpdates', 'action', 'serviceId', 'addOns', 'question', 'optionIds', 'datePreference'],
  properties: {
