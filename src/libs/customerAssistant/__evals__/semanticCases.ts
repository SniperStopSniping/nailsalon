...
export function resolveSyntheticSemanticFixture(args: { facts: Facts; candidate: CustomerSelection | null }): SemanticFixtureResolution {
  ...
  if (resolved.selection.blocksContinue) {
    return { kind: 'clarification', question: 'details' };
  }
  return {
    kind: 'proposal',
    selection: {
...
export const SEMANTIC_EVAL_CASES: SemanticEvalCase[] = [
  ...
  { id: 'gelx-length-clarification', trustedBookingSalon: syntheticSalon, turns: [{ message: 'I want Gel-X with French.', expectedFacts: { treatment: 'gel_x', maintenance: 'new_set', french: 'yes' }, expectedAction: 'clarify', expectedSelection: 'clarify_length', critical: false }] },
  { id: 'gelx-fill', trustedBookingSalon: syntheticSalon, turns: [{ message: 'I need a fill on my existing Gel-X.', expectedFacts: { treatment: 'gel_x', maintenance: 'refill', existingProduct: 'gel_x', desiredApplication: 'extensions' }, expectedAction: 'propose', expectedSelection: 'gelx_fill', critical: true }] },
  { id: 'gelx-refill-french', trustedBookingSalon: syntheticSalon, turns: [{ message: 'Can you refill my Gel-X with French tips?', expectedFacts: { treatment: 'gel_x', maintenance: 'refill', existingProduct: 'gel_x', desiredApplication: 'extensions', french: 'yes' }, expectedAction: 'propose', expectedSelection: 'gelx_fill', critical: true }] },
  { id: 'gelx-fill-here', trustedBookingSalon: syntheticIsla, turns: [{ message: 'Can you guys fill the Gel-X I got at Synthetic Isla?', expectedFacts: { treatment: 'gel_x', maintenance: 'refill', existingProduct: 'gel_x', desiredApplication: 'extensions', origin: 'this_salon' }, expectedAction: 'propose', expectedSelection: 'gelx_fill', critical: true }] },
  { id: 'gelx-fill-other-salon', trustedBookingSalon: syntheticSalon, turns: [{ message: 'I have Gel-X from another salon and need a fill.', expectedFacts: { treatment: 'gel_x', maintenance: 'refill', existingProduct: 'gel_x', desiredApplication: 'extensions', origin: 'other_salon' }, expectedAction: 'propose', expectedSelection: 'gelx_fill', critical: true }] },
  ...
  { id: 'biab-natural', trustedBookingSalon: syntheticSalon, turns: [{ message: 'I want BIAB on my natural nails.', expectedFacts: { treatment: 'builder_gel', maintenance: 'new_set', desiredApplication: 'natural_nails', existingProduct: 'none' }, expectedAction: 'propose', expectedSelection: 'biab_overlay', critical: true }] },
  { id: 'builder-gel-french', trustedBookingSalon: syntheticSalon, turns: [{ message: 'Builder gel overlay with French tips on natural nails.', expectedFacts: { treatment: 'builder_gel', maintenance: 'new_set', desiredApplication: 'natural_nails', existingProduct: 'none', french: 'yes' }, expectedAction: 'propose', expectedSelection: 'biab_overlay', critical: true }] },
  ...
  { id: 'gel-manicure-french-repairs', trustedBookingSalon: syntheticSalon, turns: [{ message: 'Gel manicure with French and three nail repairs.', expectedFacts: { treatment: 'gel_polish', desiredApplication: 'natural_nails', french: 'yes', repairCount: 3 }, expectedAction: 'propose', expectedSelection: 'gel_manicure', critical: true }] },
  ...
  { id: 'length-correction', trustedBookingSalon: syntheticSalon, turns: [{ message: 'I want Gel-X with French.', expectedFacts: { treatment: 'gel_x', maintenance: 'new_set', french: 'yes' }, expectedAction: 'clarify', expectedSelection: 'clarify_length', critical: false }, { message: 'Actually medium, not long.', expectedFacts: { length: 'medium' }, expectedAction: 'propose', expectedSelection: 'gelx_medium', critical: true }] },
  { id: 'service-correction', trustedBookingSalon: syntheticSalon, turns: [{ message: 'I want a Gel-X fill.', expectedFacts: { treatment: 'gel_x', maintenance: 'refill', existingProduct: 'gel_x' }, expectedAction: 'propose', expectedSelection: 'gelx_fill', critical: true }, { message: 'Sorry, I mean a new short Gel-X set.', expectedFacts: { maintenance: 'new_set', length: 'short' }, expectedAction: 'propose', expectedSelection: 'gelx_short', critical: true }] },
  ...
  { id: 'natural-versus-existing-ambiguity', trustedBookingSalon: syntheticSalon, turns: [{ message: 'I want French Gel-X. I might still have something on my nails.', expectedFacts: { treatment: 'gel_x', maintenance: 'new_set', french: 'yes', existingProduct: 'unknown' }, expectedAction: 'clarify', expectedSelection: 'clarify_existing_product', critical: false }] },
