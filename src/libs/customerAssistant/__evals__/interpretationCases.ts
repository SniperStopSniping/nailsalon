...
export const CUSTOMER_INTERPRETATION_EVAL_CASES: CustomerInterpretationEvalCase[] = [
  ...
  { id: 'friday-to-saturday-correction', messages: ['Friday afternoon please.', 'Actually Saturday instead.'], lastShown: { question: null, options: [], selection: shortGelxFrench }, today: '2026-09-18', timeZone: 'America/Toronto', bookingState: { ...acceptedShortGelxBooking, datePreference: { date: '2026-09-18', earliest: '12:00', latest: '17:00' } }, expected: { action: 'availability', datePreference: { date: '2026-09-19', earliest: '12:00', latest: '17:00' } } },
