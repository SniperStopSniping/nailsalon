...
export const OWNER_ASSISTANT_REGISTRY: readonly RegistryEntry[] = [
  ...
  entry('business_hours', 'Business hours', 'Opening hours and timezone (Settings → Business profile).', ['business hours', 'opening hours', 'hours', 'open', 'closed', 'timezone', 'time zone', 'change my hours'], { type: 'admin', app: 'settings', view: 'business-profile' }),
  ...
  entry('booking_rules', 'Booking rules', 'Minimum notice, slot interval, buffers, currency and confirmation settings.', ['booking rules', 'minimum notice', 'notice', 'slot interval', 'buffer', 'currency', 'confirmation', 'cutoff', 'lead time', 'how far in advance'], { type: 'admin', app: 'settings', view: 'booking' }),
  entry('settings_booking_policy', 'Booking policy', 'Cancellation and no-show policy shown to customers.', ['booking policy', 'cancellation policy', 'no-show', 'no show', 'policy', 'terms'], { type: 'admin', app: 'settings', view: 'booking-policy' }),
  ...
  entry('settings_review_requests', 'Review requests', 'Automatic review requests after appointments.', ['review requests', 'ask for reviews', 'google reviews', 'review link'], { type: 'admin', app: 'settings', view: 'review-requests' }),
