...
export const OWNER_ASSISTANT_REGISTRY: readonly RegistryEntry[] = [
  ...
  entry('calendar_block_time', 'Block Time', 'Reserve a specific part of your calendar for a break or personal commitment.', ['block time', 'blocked time', 'block my calendar', 'block an afternoon', 'calendar block', 'break', 'personal appointment'], { type: 'admin', app: 'schedule', view: 'block-time' }, 'exact_on_open'),
  ...
  entry('settings_branding', 'Booking Messages & Social Links', 'Booking messages, social links and confirmation text.', ['social links', 'instagram', 'booking messages', 'confirmation message'], { type: 'bookingPage', panel: 'experience' }),
  ...
  entry('settings_notifications', 'Owner & Staff Alerts', 'What you and your staff get notified about.', ['notifications', 'notify', 'alerts', 'bell'], { type: 'admin', app: 'settings', view: 'notifications' }),
  ...
  entry('page_information', 'What Clients See', 'What business details customers see, including hours and bio visibility.', ['business info', 'business information', 'what clients see', 'show bio', 'hide bio', 'display hours', 'contact details shown', 'address privacy', 'show address', 'hide address'], { type: 'bookingPage', panel: 'information' }),
