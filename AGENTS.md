...
- Before starting unrelated work, finish the current delivery path: run the relevant checks, commit the scoped changes, push the branch, verify the preview, open or update its pull request, and merge it after every required gate passes.
